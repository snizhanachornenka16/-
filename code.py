...
data = {
    'ip_address': ['192.168.1.10', '10.0.0.5', '192.168.1.10', '172.16.0.1', '10.0.0.5', 
                   '192.168.1.100', '192.168.1.10', '10.0.0.20', '172.16.0.1', '192.168.1.50'],
    'start_time': pd.to_datetime(['2026-05-01 10:00:00', '2026-05-01 10:05:00', '2026-05-01 10:10:00',
                                  '2026-05-01 10:15:00', '2026-05-01 10:20:00', '2026-05-01 11:00:00',
                                  '2026-05-01 11:05:00', '2026-05-01 11:10:00', '2026-05-01 11:15:00',
                                  '2026-05-01 11:20:00']),
    'end_time': pd.to_datetime(['2026-05-01 10:02:00', '2026-05-01 10:07:00', '2026-05-01 10:40:00',
                                '2026-05-01 10:16:00', '2026-05-01 10:25:00', '2026-05-01 11:05:00',
                                '2026-05-01 11:06:00', '2026-05-01 11:15:00', '2026-05-01 12:30:00',
                                '2026-05-01 11:25:00']),
    'traffic_mb': [150, 45, 1200, 10, 85, 300, 15, 60, 2500, 40],
    'protocol': ['TCP', 'UDP', 'TCP', 'HTTP', 'TCP', 'HTTPS', 'UDP', 'TCP', 'HTTPS', 'HTTP'],
    'status': ['Success', 'Success', 'Success', 'Failed', 'Success', 'Success', 'Success', 'Success', 'Success', 'Success']
}

df_test = pd.DataFrame(data)
df_test.to_csv('network_logs.csv', index=False)
print("Тестовий файл 'network_logs.csv' успішно створено.")
